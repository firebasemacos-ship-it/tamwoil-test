        ...
        <div className="min-h-screen bg-slate-950 text-white pb-20" dir="rtl">
            <div className="bg-slate-900/50 backdrop-blur-xl border-b border-slate-800/50 sticky top-0 z-20 px-4 py-4">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    <h1 className="text-2xl font-black flex items-center gap-2">
                        ...
                        <span className="bg-gradient-to-l from-blue-400 to-blue-500 bg-clip-text text-transparent">المتجر</span>
                    </h1>
                </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto p-4 space-y-6">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                    <button onClick={() => setSelectedCategory(null)} className={`px-6 py-3 rounded-full font-bold whitespace-nowrap transition-all ${!selectedCategory ? 'bg-blue-600 shadow-lg shadow-blue-500/20' : 'bg-slate-900 border border-slate-800'}`}>الكل</button>
                        ...
                        >
                            ...
                            <div className="p-3">
                                ...
                                <div className="text-xs text-slate-400 mt-1 flex justify-between items-center">
                                    <span>يبدأ من</span>
                                    <span className="text-blue-400 font-bold">{getLowestPriceForPackage(pkg)} د.ل</span>
                                </div>
                            </div>
                        </motion.div>
                    ))}
                                    ...
                                    {selectedPackage.variants?.map(variant => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className="text-blue-400 font-bold text-xs mt-1">{price} د.ل</span>
                                            </button>
                                        );
                                    })}
                                </div>
