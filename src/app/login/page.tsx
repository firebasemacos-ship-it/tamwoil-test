        ...
        <div className="flex min-h-screen bg-background text-foreground overflow-hidden">
            ...
            <div className="hidden lg:flex w-1/2 bg-primary/95 relative items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <h1 className="text-4xl font-bold text-white mb-6">تمويل</h1>
                    <p className="text-xl text-white/80 leading-relaxed">
                        نظام تمويل - شريكك الموثوق في عالم الخدمات اللوجستية. نضمن وصول شحناتك بأمان وسرعة.
                    </p>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    >
                        ...
                        <div className="flex justify-center gap-2">
                            <a href="tel:0946691233" className="inline-flex items-center gap-2 text-primary font-semibold hover:text-primary/80 transition-colors bg-primary/10 px-4 py-2 rounded-full">
                                <Phone className="w-4 h-4" />
                                <span dir="ltr">094-6691233</span>
                            </a>
                        </div>

                        <div className="mt-4 text-xs text-slate-400">
                            طبرق – حي اشبيليا، مقابل الاستخبارات العسكرية
                        </div>
                    </motion.footer>
                </div>
            </div>
